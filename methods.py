...
# ayarlar icon
icon_path_Settings = "icons/Settings.ico"
# oyun icon
icon_path_game = "icons/xox.ico"

ANIMATION_SPEED = 5
WIN_LINE_COLOR = (0, 255, 0, 255)  # Kazanan çizgisi rengi (yeşil)
WIN_LINE_WIDTH = 4  # Kazanan çizgisi kalınlığı
WIN_LINE_ANIMATION_SPEED = 100  # Kazanan çizgisi animasyon hızı (daha büyük bir değer daha hızlı animasyon demektir)
